## PROYECT WEEK 3 IRONHACK DATA FT 2021-10
## DANIEL HELGUERA
...
* Construct a data pipeline with your code wrapped in functions.
* Data pipeline stages : acquisition, wrangling, analysis, and reporting.
* Demonstrate functions, list comprehensions, string operations, etc.
* Data set imported and result exported.
* Code saved in a Python executable file (.py),
* README.md file describing the steps and thought process for the data pipeline.
